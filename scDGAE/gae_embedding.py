...
from gae.model import GATModelVAE, DGCN
...
def GAEembedding(z, adj, args):
    ...
    if args.GAEmodel == 'gcn_vae':
        ...
        adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = dp.load_graph_data(z)
