...
parser.add_argument('--zerofillFlag', action='store_true', default=False,
                    help='fill zero or not before EM process (defau lt: False)')
...
if __name__ == "__main__":
    ...
    # print(zOut.ndim)
    # print(data.T.ndim)
    # pcaFunc(zOut, n_components=mle)
    # print(zOut.ndim)
    #
    # pca_result,re = pcaFunc(zOut, n_components=mle)
    # print(pca_result.ndim)
    print(listResult.shape)
    print(type(listResult))
    # zOut = zOut.reshape(1, -1)
    drawUMAP(zOut, listResult, size, args.outputDir, args.datasetName, True)