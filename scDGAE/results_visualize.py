...
# Use all
#z = pd.read_csv('/Users/fengfengxiang/Desktop/scgnnc/Data/sc/GSM13885232/GSM13885232.features.csv',header=None)
...
# Main plots:
#edgeList = np.load('GSM13885232_LTMG_10-0.1-0.9-0.0-0.3-0.1_final_edgeList')
...
#_, edgeList = generateAdj(z, graphType='KNNgraphStatsSingleThread', para = 'cosine:10')
