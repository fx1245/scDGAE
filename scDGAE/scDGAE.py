...
parser.add_argument('--GAEh_dim', type=int, default=32,
                    help='Number of units in hidden layer 1.')
parser.add_argument('--GAEz_dim', type=int, default=16,
                    help='Number of units in hidden layer 2.')
parser.add_argument('--GAEheads', type=int, default=3,
                    help='Number of units in hidden layer 2.')
...
if __name__ == "__main__":
    ...
    debuginfoStr('scGAEGAT finished')
    #print(zOut.shape)
    #print(size)
    drawUMAP(zOut, listResult, size, args.npyDir, args.datasetName, True)
    # print(pcaFunc(zOut, n_components=100))
    X_zero, i, j, ix = scData.features, scData.i, scData.j, scData.ix
    # print(imputation_error(reconOut, scData.featuresOriginal, X_zero, i, j, ix))
    print(imputation_error_log(reconOut, scData.featuresOriginal, X_zero, i, j, ix))
    print(imputation_cosine_log(reconOut, scData.featuresOriginal, X_zero, i, j, ix))
    # print(imputation_cosine(reconOut, scData.featuresOriginal, X_zero, i, j, ix))
